...
import { login as loginRequest, loginDemo as loginDemoRequest, token$, updateUser, endSession, type UserType, type UpdateType, UserSchema } from "../api/users"
...
const loginDemo = async (callback: Callback): Promise<void> => {
...
export { user$, login, loginDemo, logout, update }
